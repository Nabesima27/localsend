...
class SignalingStateMapper extends ClassMapperBase<SignalingState> {
  ...
  static LsSignalingConnection? _$connection(SignalingState v) => v.connection;
  static const Field<SignalingState, LsSignalingConnection> _f$connection = Field('connection', _$connection);
  ...
  static SignalingState _instantiate(DecodingData data) {
    return SignalingState(
        signalingServers: data.dec(_f$signalingServers), stunServers: data.dec(_f$stunServers), connection: data.dec(_f$connection));
  }
...
abstract class SignalingStateCopyWith<$R, $In extends SignalingState, $Out> implements ClassCopyWith<$R, $In, $Out> {
  ...
  $R call({List<String>? signalingServers, List<String>? stunServers, LsSignalingConnection? connection});
...
class _SignalingStateCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, SignalingState, $Out>
  ...
  @override
  $R call({List<String>? signalingServers, List<String>? stunServers, Object? connection = $none}) => $apply(FieldCopyWithData({
